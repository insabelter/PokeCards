        ...
        <div class="col-lg-3 col-md-6" style="padding: 0; margin-top: 10px;">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <input type="submit" name="submit" id="submit" class="btn btn-primary" data-toggle="tooltip" title="start the search" value="Submit">
                </div>
            </div>
        </div>
    </form>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <form method="post" action="/marketplace/watch">
                                    ...
                                    @if(!$offer->watched)
                                        <button type="submit" class="btn btn-sm btn-primary" data-toggle="tooltip" title="add to watchlist">
